		...
		<table class='listado'>
			...
			while ($i < $arrayLength) {?>
				<tr class="listado__row">						
					<td><a href="<?php echo site_url("/ventas/pdfRemito/".$remitos[$i]->id);?>"><?php echo str_pad($remitos[$i]->id,4,"0",STR_PAD_LEFT);?></a> </td>
					<td class="listado__fecha"> <?php echo  $remitos[$i]->fecha;?></td>
					<td> <?php echo strtoupper($remitos[$i]->nombre);?></a></td>
					<td> <?php echo $remitos[$i]->emisor;?></td>
