		...
		<header class="header">
			<nav class="nav-bar">
				...
				<ul class="menu__item" id="menuItems" >
					<li class="dropdown__item <?php echo($active[0]); ?>" id="home"><i class="fa-solid fa-house"></i><a href="<?php echo base_url(); ?>/home">INICIO</a></li> 
					<li class="dropdown__item <?php echo($active[1]); ?>" id="equipos">
						<i class="fa-solid fa-bolt"></i><a href="<?php echo base_url(); ?>/equipos/" >  EQUIPOS</a>
					</li>
					<li class="dropdown__item <?php echo($active[2]); ?>" id="ventas">
						<i class="fa-solid fa-money-check-dollar"></i><a href="<?php echo base_url(); ?>/ventas/">VENTAS</a>
					</li>
					<li class="dropdown__item <?php echo($active[3]); ?>" id="rrhh">
